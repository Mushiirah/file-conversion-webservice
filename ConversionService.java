...
public class ConversionService {
	...
	public File convertFile (File sourceFile, String targetType) throws IOException, InterruptedException {
		...
		String targetAbsolutePath = HelloWorld.TARGET_FOLDER + "/" + FilenameUtils.getBaseName(sourceFile.getName() + "." + targetType);
		...
		builder.directory( new File(HelloWorld.TARGET_FOLDER).getAbsoluteFile() ); // this is where you set the root folder for the executable to run with
